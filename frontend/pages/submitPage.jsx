...
import { reverseGeocode } from './MapPage';
import { Btn, Input, Select, Card, Toast, Spinner } from '../components/ui';
  ...
  function captureLocation() {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        // Uses shared reverseGeocode() from MapPage — calls Google Geocoding API
        // if REACT_APP_GOOGLE_MAPS_KEY is set, else falls back to coordinates
        ...
        <Card>
          ...
          {!location ? (
            ...
            <div>
              ...
              {/* Map placeholder (replace with Google Maps embed if key available) */}
              <div style={{ background: '#1A1E2A', borderRadius: 12, border: '1px solid rgba(255,255,255,0.07)', height: 180, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ textAlign: 'center', zIndex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, color: '#3A4256', marginTop: 4 }}>Add REACT_APP_GOOGLE_MAPS_KEY for live map</div>
                </div>
              </div>
